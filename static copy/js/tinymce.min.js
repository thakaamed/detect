 ...
 * Version: 3.2.0-24
 */
!function(){"use strict";function n(t){return function(n){return e=typeof(n=n),(null===n?"null":"object"==e&&(Array.prototype.isPrototypeOf(n)||n.constructor&&"Array"===n.constructor.name)?"array":"object"==e&&(String.prototype.isPrototypeOf(n)||n.constructor&&"String"===n.constructor.name)?"string":e)===t;var e}}function e(e){return function(n){return typeof n===e}}function a(n){return!(null==n)}function o(){}function i(n){return function(){return n}}function t(n){return n}var r,s=n("string"),l=n("object"),c=e("boolean"),u=function(n){return r===n},f=e("function"),C=e("number"),d=i(!1),m=i(!(r=void 0)),p=function(){return(p=Object.assign||function(n){for(var e,t=1,r=arguments.length;t<r;t++)for(var o in e=arguments[t])Object.prototype.hasOwnProperty.call(e,o)&&(n[o]=e[o]);return n}).apply(this,arguments)};function g(n,e,t){if(t||2===arguments.length)for(var r,o=0,i=e.length;o<i;o++)!r&&o in e||((r=r||Array.prototype.slice.call(e,0,o))[o]=e[o]);return n.concat(r||Array.prototype.slice.call(e))}function v(){return y}var F=function(n){n=n.chiffer_cdp_init_service_url;return s(n)?n:void 0},y={fold:function(n,e){return n()},isSome:d,isNone:m,getOr:t,getOrThunk:h,getOrDie:function(n){throw new Error(n||"error: getOrDie called on none.")},getOrNull:i(null),getOrUndefined:i(void 0),or:t,orThunk:h,map:v,each:o,bind:v,exists:d,forall:m,filter:function(){return y},toArray:function(){return[]},toString:i("none()")};function h(n){return n()}function _(t){function n(){return o}function e(n){return n(t)}var r=i(t),o={fold:function(n,e){return e(t)},isSome:m,isNone:d,getOr:r,getOrThunk:r,getOrDie:r,getOrNull:r,getOrUndefined:r,or:n,orThunk:n,map:function(n){return _(n(t))},each:function(n){n(t)},bind:e,exists:e,forall:e,filter:function(n){return n(t)?o:y},toArray:function(){return[t]},toString:function(){return"some("+t+")"}};return o}function N(n,t,r,o){for(var e=n,i=function(n,e){(t(n,e)?r:o)(n,e)},c=U(e),a=0,u=c.length;a<u;a++){var s=c[a];i(e[s],s)}}function z(n,e){var t,r={};return N(n,e,(t=r,function(n,e){t[e]=n}),o),r}function L(){return(new Date).getTime()}function b(n){return parseInt(n,10)}function M(n,e,t){return{major:n,minor:e,patch:t}}function H(n){return ln(n.editorManager)}function K(n,e){return-1<dn.call(n,e)}function w(i,c){return function(n){var e=n.options,t=c.processor,r=c.legacyProcessor,o=c.defaultValue;return(a(e)?(e.isSet(i)?A.from(e.get(i)):A.none()).bind(t):r(n.getParam(i))).getOr(o)}}function J(n){return vn(n,"/")}function W(e){return function(n){return e(n)?A.some(n):A.none()}}function S(n){return R(n).filter((e=J,function(n){return!e(n)}));var e}function k(n){return s(n)?A.some(n):c(n)||C(n)?A.some(n.toString()):A.none()}function Z(n){return n=n.plugins,n=z(n,function(n,e){var t=K(pn,e),n=!!n.isStub;return!!e&&!n&&!("chiffer"===e)&&t}),0<(n=U(n)).length?n:void 0}function q(n,e){var t,r,o=tinymce.Env,i=sn(),c="unknown",e=function(n){n=n.tiny_cloud_entry_url;return s(n)?n:void 0}(e),o=(l(o.os)&&(t={name:o.os.current||c,version:null==(t=o.os.version)?void 0:t.major.toString()}),l(o.os)&&(r={name:o.browser.current||c,version:null==(c=o.browser.version)?void 0:c.major.toString()}),null==i?void 0:i.timeZone),c=null==i?void 0:i.locale,i={width:window.innerWidth,height:window.innerHeight,density:window.devicePixelRatio},a=navigator.userAgent,u=function(){var n;try{return null==(n=navigator.userAgentData)?void 0:n.toJSON()}catch(n){}}();return p(p({},n),{browser:r,os:t,timezone:o,locale:c,screen:i,userAgent:a,userAgentData:u,tinyCloudEntryUrl:e})}function B(n,e){var t=function(n){n=H(n);return"".concat(n.major,".").concat(n.minor,".").concat(n.patch)}(n),r=gn.getIdForEditor(n);return{apiKey:e.apiKey,pageId:e.pageId,editorId:r,editorVersion:t,editorOptions:function(n){var e,t,r,o,i,c,a,u,s,l,f;if(!fn(n))return e=yn(n),t=kn(n),r=hn(n),o=_n(n),i=bn(n),c=Sn(n),a=wn(n),u=jn(n),s=On(n),l=In(n),f=Pn(n),{plugins:Z(n),icons:i,inline:e,language:t,readonly:r,resize:o,skin:c,theme:a,height:u,toolbarMode:s,toolbarLocation:l,uiMode:f}}(n)}}function G(n){return"plugin_".concat(n,"_loaded")}var Q,X,O,Y,I,$,P,nn,j,en,x,T,A={some:_,none:v,from:function(n){return null==n?y:_(n)}},D=function(){for(var n=[],e=0;e<256;e++)n.push((e+256).toString(16).substring(1));return n}(),tn=A.from(window.crypto),rn=function(){return tn.bind(function(n){return f(n.randomUUID)?A.some(n.randomUUID()):A.none()})},on=function(){return e=new Uint8Array(16),tn.bind(function(n){return f(n.getRandomValues)?A.some(n.getRandomValues(e)):A.none()}).map(function(n){for(var e="",t=0;t<16;t++){var r=n[t];e+=6===t?D[15&r|64]:8===t?D[63&r|128]:D[r],3!==t&&5!==t&&7!==t&&9!==t||(e+="-")}return e});var e},cn="00000000-0000-0000-0000-000000000000",an=function(){return rn().orThunk(on)},U=Object.keys,un=Object.hasOwnProperty,E=function(n,e){return un.call(n,e)},sn=(O=!(Q=function(){if(a(Intl))return Intl.DateTimeFormat().resolvedOptions()}),function(){for(var n=[],e=0;e<arguments.length;e++)n[e]=arguments[e];return O||(O=!0,X=Q.apply(null,n)),X}),ln=function(n){n=[n.majorVersion,n.minorVersion].join(".").split(".").slice(0,3).join(".");return(n=/([0-9]+)\.([0-9]+)\.([0-9]+)(?:(\-.+)?)/.exec(n))?M(b(n[1]),b(n[2]),b(n[3])):M(0,0,0)},fn=(Y=4,function(n){return H(n).major===Y}),dn=Array.prototype.indexOf,mn=function(n,e){for(var t=0,r=n.length;t<r;t++)e(n[t],t)},pn=g(g([],["accordion","advlist","anchor","autolink","autoresize","autosave","bbcode","charmap","code","codesample","colorpicker","compat3x","contextmenu","directionality","emoticons","fullpage","fullscreen","help","hr","image","imagetools","importcss","insertdatetime","legacyoutput","link","lists","media","nonbreaking","noneditable","pagebreak","paste","preview","print","quickbars","save","searchreplace","spellchecker","tabfocus","table","template","textcolor","textpattern","toc","visualblocks","visualchars","wordcount"],!0),["a11ychecker","advcode","advtable","advtemplate","ai","autocorrect","casechange","checklist","editimage","export","footnotes","formatpainter","inlinecss","linkchecker","mediaembed","mentions","mergetags","pageembed","permanentpen","powerpaste","rtc","tableofcontents","tinycomments","tinydrive","tinymcespellchecker","typography"],!0),gn=(I=new WeakMap,{getIdForEditor:function(e){return A.from(I.get(e)).getOrThunk(function(){var n=an().getOr(cn);return I.set(e,n),n})}}),vn=function(n,e){return-1!==n.indexOf(e)},R=W(s),V=W(c),yn=w("inline",{processor:A.some,legacyProcessor:V}),hn=w("readonly",{processor:A.some,legacyProcessor:V}),_n=w("resize",{processor:k,legacyProcessor:k}),bn=w("icons",{processor:S,legacyProcessor:S}),wn=w("theme",{processor:S,legacyProcessor:S}),Sn=w("skin",{processor:S,legacyProcessor:S}),kn=w("language",{processor:S,legacyProcessor:S}),On=w("toolbar_mode",{processor:A.some,legacyProcessor:R}),In=w("toolbar_location",{processor:R,legacyProcessor:R}),Pn=w("ui_mode",{processor:R,legacyProcessor:A.none}),jn=w("height",{processor:k,legacyProcessor:k}),xn=function(n,e){if(f(window.fetch))try{var t={method:"POST",mode:"cors",headers:new window.Headers({"Content-Type":"application/json"}),body:JSON.stringify(e),keepalive:!0};window.fetch(n,t).then(o,o)}catch(n){}},Tn={direct:!1,library:{name:"chiffer",version:"3.2.0-24"}},An=function(n,e,t){t=q(Tn,t),n=B(n,e);return{anonymousId:e.pageId,event:"editor_init",context:t,properties:n}},Dn={mceInsertToc:"toc_insert",mceUpdateToc:"toc_update"},Un={mceEditImage:"imagetools_open_dialog",mceImageRotateLeft:"imagetools_rotate",mceImageRotateRight:"imagetools_rotate",mceImageFlipVertical:"imagetools_flip",mceImageFlipHorizontal:"imagetools_flip"},En={InsertUnorderedList:!0,InsertOrderedList:!0},Rn={mceInsertTemplate:"template_insert",mceInsertDate:"insertdatetime_insert",mceInsertTime:"insertdatetime_insert",mcePreview:"preview_open_dialog",mceAnchor:"anchor_open_dialog"},Vn=function(n){if(a(n.value)&&E(n.value,"list-style-type"))return n=n.value["list-style-type"],"advlist_".concat(""===n?"default":n)},Cn=["a11ychecker","advcode","advtable","autocorrect","casechange","checklist","editimage","export","footnotes","formatpainter","inlinecss","linkchecker","mediaembed","mentions","mergetags","pageembed","permanentpen","powerpaste","rtc","tableofcontents","tinycomments","tinydrive","tinymcespellchecker","typography"],Fn=function(n){for(var n=z(n,function(n,e){n=!!n.isStub;return!!e&&!n&&K(Cn,e)}),e=U(n),t=G,r=e.length,o=new Array(r),i=0;i<r;i++){var c=e[i];o[i]=t(c,i)}return o},Nn=function(a,u){return{send:function(n,e,t){var r,o=a,i=L(),c="undefined"!=typeof Intl?encodeURIComponent(Intl.DateTimeFormat().resolvedOptions().timeZone):"N%2FA",o="?aid=".concat(o,"&tna=").concat("tinymce_cloud","&p=").concat("web","&dtm=").concat(e,"&stm=").concat(i,"&tz=").concat(c,"&e=").concat("se","&se_ca=").concat(n),e=function(n){n=n.chiffer_snowplow_service_url;return s(n)?n:void 0}(u);s(e)?((r=document.createElement("img")).src=e+o,r.onload=(i=function(n){return function(){r.onload=null,r.onerror=null,t(n)}})(!0),r.onerror=i(!1)):t(!1)}}},zn=function(e){return{sendStat:function(n){e.send(n,L(),o)}}};V={load:o},T=null!=(T=tinymce.defaultOptions)?T:tinymce.defaultSettings,x=function(n){n=n.api_key;return s(n)?n:void 0}(T=p({},T)),T=u(x)?V:(j=function(n,e){n=Nn(n,e);return zn(n)}(V=x,x=T),$=V,P=x,nn=an().getOr(cn),en={sendInit:function(n){var e=F(P);s(e)&&(n=An(n,{apiKey:$,pageId:nn},P),xn(e,n))}},j.sendStat("script_load"),{load:function(t){t.once("init",function(){return j.sendStat("init")}),t.once("init",function(){return en.sendInit(t)}),t.once("focus",function(){return j.sendStat("focus")}),t.on("ExportPdf",function(){return j.sendStat("export_pdf")}),t.on("InlineCSS",function(){return j.sendStat("inlinecss_get_content")}),t.on("PastePreProcess PowerPasteTempStats",function(n){n=n.source;a(n)&&j.sendStat("powerpaste_".concat(n))}),t.on("VisualChars",function(n){!0===n.state&&j.sendStat("visualchars_true")}),t.on("RtcSessionConnected",function(n){var e=n.time;switch(e){case 0:j.sendStat("rtc_started");break;case 5:case 10:case 20:j.sendStat("rtc_connected_".concat(e,"min"))}}),t.on("RtcSessionError",function(){return j.sendStat("rtc_error")}),t.on("RtcSessionDirty",function(){return j.sendStat("rtc_edited")}),t.on("SpellcheckerLanguageChanged",function(n){n=n.language;j.sendStat("spellcheckerpro_language_changed_".concat(n))}),t.on("ExecCommand",function(n){e=(n=n).command;var e,n=E(En,e)?Vn(n):E(Un,e)?Un[e]:E(Dn,e)?Dn[e]:E(Rn,e)?Rn[e]:void 0;u(n)||j.sendStat(n)}),t.on("PreInit",function(){var n=j,e=t.plugins;e=Fn(e),mn(e,n.sendStat)})}}),tinymce.PluginManager.add("chiffer",T.load)}();

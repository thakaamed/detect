class MultiInput extends HTMLElement {
  ...
  _addItem(value) {
    ...
    // this.insertBefore(item, this._input); bu satır var idi ben bunu kapadım aşağıdakini yazdım e.b
    this.insertBefore(item, this._input.nextSibling)
    console.log("elemann eklendi", this)
    item.onclick = () => {

...
THREE.DRACOLoader.prototype = Object.assign( Object.create( THREE.Loader.prototype ), {
	...
	decodeDracoFile: function ( buffer, callback, attributeIDs, attributeTypes ) {
		...
		this.decodeGeometry( buffer, taskConfig ).then( (bufferGeometry) => {
			callback;
		});
	...
	_loadLibrary: function ( url, responseType ) {
		...
		return new Promise( ( resolve, reject ) => {
			console.log(`return new Promise: ${url}}`);
	...
	_initDecoder: function () {
		...
		if ( useJS ) {
			...
			librariesPending.push( this._loadLibrary( '../../static/dicom/stl-viewer/draco_wasm_wrapper.js', 'text' ) );
			librariesPending.push( this._loadLibrary( '../../static/dicom/stl-viewer/draco_decoder.wasm', 'arraybuffer' ) );

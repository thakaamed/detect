...
class Farnet(nn.Module):
    def __init__(self):
        ...
        self.conv_11_refine = nn.Conv2d(64, 42, kernel_size=1)
        self.conv_33_last1 = nn.Conv2d(138, 138, kernel_size=3, stride=1, padding=1)
        self.conv_33_last2 = nn.Conv2d(138, 138, kernel_size=3, stride=1, padding=1)
        self.conv_11_last = nn.Conv2d(138, 42, kernel_size=1)
